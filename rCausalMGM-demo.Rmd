...
* Tiers: ordered sets of variables where variables in tier t can only be ancestors of variables in tier t+1 and descendants of variables in tier t-1. Tiers may be modified so that they can not form edges within a given tier using the `forbidWithinTier` argument.
