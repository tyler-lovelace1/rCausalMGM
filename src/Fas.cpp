 ...
 */
EdgeListGraph Fas::search() {
    Rcpp::Rcout << "Starting Fast Adjacency Search." << std::endl;
    ...
    Rcpp::Rcout << "Finishing Fast Adjacency Search." << std::endl;

    return graph;
}

std::unordered_map<Variable*, std::unordered_set<Variable*>> Fas::searchMapOnly() {
    Rcpp::Rcout << "Starting Fast Adjacency Search." << std::endl;
...
bool Fas::searchAtDepth0(std::vector<Variable*>& nodes, IndependenceTest *test, std::unordered_map<Variable*, std::unordered_set<Variable*>>& adjacencies) {
...
bool Fas::searchAtDepth(std::vector<Variable*>& nodes, IndependenceTest *test, std::unordered_map<Variable*, std::unordered_set<Variable*>>& adjacencies, int depth) {
    int count = 0;
