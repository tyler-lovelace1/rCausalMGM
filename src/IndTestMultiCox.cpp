...
IndTestMultiCox::IndTestMultiCox(DataSet& data, double alpha)
{
    this->timesCalled = 0;
...
IndTestMultiCox::IndTestMultiCox(DataSet& data, double alpha, bool preferLinear)
{
    this->timesCalled = 0;
...
// IndTestMultiCox::~IndTestMultiCox() {
 ...
 */
bool IndTestMultiCox::isIndependent(const Node& x, const Node& y, std::vector<Node> &z, double *pReturn)
{
    this->timesCalled++;
...
bool IndTestMultiCox::isIndependentMultinomialLogisticRegression(const Node& x, const Node& y, std::vector<Node>& z, double *pReturn)
{
...
arma::uvec IndTestMultiCox::getNonMissingRows(const Node& x, const Node& y, std::vector<Node>& z)
{
...
bool IndTestMultiCox::isMissing(const Node& x, int i)
{
...
bool IndTestMultiCox::isIndependentRegression(const Node& x, const Node& y, std::vector<Node>& z, double *pReturn)
{
    if (variablesPerNode.count(x) < 1)
    {
...
bool IndTestMultiCox::isIndependentCoxRegression(const Node& x, const Node& y, std::vector<Node> &z, double *pReturn)
{
	...
	p = 1.0 - R::pchisq(chisq, df, true, false); // lower.tail = TRUE, log.p = FALSE
 ...
 */
std::vector<std::string> IndTestMultiCox::getVariableNames()
{
