...
public:
    ...
    CoxIRLSRegression(CoxIRLSRegression& lr);
    CoxIRLSRegression(CoxIRLSRegression&& lr);
    // CoxIRLSRegression(arma::mat data, std::vector<Node>&  variables);

    CoxIRLSRegression& operator=(CoxIRLSRegression& lr);
    CoxIRLSRegression& operator=(CoxIRLSRegression&& lr);
     ...
     * constant.
     */
    CoxRegressionResult regress(Node target,
