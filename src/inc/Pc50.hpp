...
private:
    ...
    // Score for triples based on sepsetCount = # sepsets without y / max(total # of sepsets, 1)
    // Scores > 0.5 indicated a collider, 
    std::unordered_map<Triple, double> score;
...
public:
     ...
     */
    Pc50(IndependenceTest *independenceTest);
