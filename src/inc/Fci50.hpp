...
private:
     ...
     */
    // SepsetProducer* sepsetsMajority = NULL;
...
public:
        //============================CONSTRUCTORS============================//
    /**
     * Constructs a new FCI50 search for the given independence test and background knowledge.
     */
    Fci50(IndependenceTest *test);

    /**
     * Constructs a new FCI50 search for the given independence test and background knowledge and 
     * a list of variables to search over.
     */
    Fci50(IndependenceTest *test, std::vector<Node> searchVars);
