#ifndef FASSTABLECONCURRENT_HPP_
#define FASSTABLECONCURRENT_HPP_
...
private:
    ...
    void computeDepth0(std::unordered_map<Variable*, std::unordered_set<Variable*>>& adjacencies, int from, int to);
    void computeDepth(std::unordered_map<Variable*, std::unordered_set<Variable*>>& adjacencies, std::unordered_map<Variable*, std::unordered_set<Variable*>>& adjacenciesCopy, int depth, int from, int to);
...
public:
    ...
    FasStableConcurrent(EdgeListGraph *initialGraph, IndependenceTest *test);
    FasStableConcurrent(IndependenceTest *test);
...
#endif /* FASSTABLECONCURRENT_HPP_ */