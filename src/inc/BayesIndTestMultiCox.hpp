#ifndef BAYESINDTESTMULTICOX_HPP_
#define BAYESINDTESTMULTICOX_HPP_
...
class BayesIndTestMultiCox : public IndependenceTest {
private:
    int timesCalled;
...
public:
    BayesIndTestMultiCox() {}

    BayesIndTestMultiCox(DataSet& data, double alpha);

    BayesIndTestMultiCox(DataSet& data, double alpha, bool preferLinear);

    BayesIndTestMultiCox(const BayesIndTestMultiCox& other) = default;
    BayesIndTestMultiCox& operator=(const BayesIndTestMultiCox& other) = default;

    BayesIndTestMultiCox(BayesIndTestMultiCox&& other) = default;
    BayesIndTestMultiCox& operator=(BayesIndTestMultiCox&& other) = default;

    ~BayesIndTestMultiCox() = default;
    ...
    void clearWZmap() { WZmap.clear(); }

    friend void BayesIndTestMultiCoxTest(const Rcpp::DataFrame& df);

};

#endif /* BAYESINDTESTMULTICOX_HPP_ */
