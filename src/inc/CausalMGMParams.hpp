#ifndef CAUSALMGMPARAMS_HPP_
#define CAUSALMGMPARAMS_HPP_

#include "armaLapack.hpp"

class CausalMGMParams {
...
private:
    ...
    arma::mat thetaT; //continuous<--discrete
    arma::mat phi;    //discrete<->discrete
    arma::vec alpha1; //cont linear node pot
    arma::vec alpha2; //disc node pot

    friend class CausalMGM;

public:
    CausalMGMParams() {}
    CausalMGMParams(const arma::mat& beta, const arma::vec& betad, const arma::mat& theta, const arma::mat& thetaT, const arma::mat& phi, const arma::vec& alpha1, const arma::vec& alpha2);
    // CausalMGMParams(CausalMGMParams& parIn);
    CausalMGMParams(arma::vec& vec, int p, int ltot);  //copy params from flattened vector
    ...
    arma::mat getThetaT() { return thetaT; }
    ...
    void setThetaT(arma::mat& thetaT) { this->thetaT = thetaT; }
    ...
    friend std::ostream& operator<<(std::ostream& os, CausalMGMParams& params);
};

#endif /* CAUSALMGMPARAMS_HPP_ */
