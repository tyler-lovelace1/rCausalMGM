...
// steps
Rcpp::List steps(const Rcpp::DataFrame& df, const int maxDiscrete, Rcpp::Nullable<Rcpp::NumericVector> lambda, const double g, const int numSub, const int subSize, Rcpp::LogicalVector leaveOneOut, Rcpp::LogicalVector computeStabs, const int threads, Rcpp::LogicalVector verbose);
...
// bootstrap
Rcpp::List bootstrap(const Rcpp::DataFrame& df, Rcpp::CharacterVector method, Rcpp::CharacterVector ensembleMethod, Rcpp::NumericVector lambda, const double alpha, const double adjThresh, const double sampleFrac, const int numBoots, const int maxDiscrete, const bool fdr, const int threads, const bool verbose);
RcppExport SEXP _rCausalMGM_bootstrap(SEXP dfSEXP, SEXP methodSEXP, SEXP ensembleMethodSEXP, SEXP lambdaSEXP, SEXP alphaSEXP, SEXP adjThreshSEXP, SEXP sampleFracSEXP, SEXP numBootsSEXP, SEXP maxDiscreteSEXP, SEXP fdrSEXP, SEXP threadsSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::DataFrame& >::type df(dfSEXP);
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type method(methodSEXP);
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type ensembleMethod(ensembleMethodSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type lambda(lambdaSEXP);
    Rcpp::traits::input_parameter< const double >::type alpha(alphaSEXP);
    Rcpp::traits::input_parameter< const double >::type adjThresh(adjThreshSEXP);
    Rcpp::traits::input_parameter< const double >::type sampleFrac(sampleFracSEXP);
    Rcpp::traits::input_parameter< const int >::type numBoots(numBootsSEXP);
    Rcpp::traits::input_parameter< const int >::type maxDiscrete(maxDiscreteSEXP);
    Rcpp::traits::input_parameter< const bool >::type fdr(fdrSEXP);
    Rcpp::traits::input_parameter< const int >::type threads(threadsSEXP);
    Rcpp::traits::input_parameter< const bool >::type verbose(verboseSEXP);
    rcpp_result_gen = Rcpp::wrap(bootstrap(df, method, ensembleMethod, lambda, alpha, adjThresh, sampleFrac, numBoots, maxDiscrete, fdr, threads, verbose));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rCausalMGM_bootstrap", (DL_FUNC) &_rCausalMGM_bootstrap, 12},
    {NULL, NULL, 0}
};
