...
CoxRegressionTest <- function(df, targetName, regressorNames) {
    invisible(.Call(`_rCausalMGM_CoxRegressionTest`, df, targetName, regressorNames))
}
...
LassoCoxTest <- function(df, maxDiscrete, lambda) {
    invisible(.Call(`_rCausalMGM_LassoCoxTest`, df, maxDiscrete, lambda))
}
...
#' data("data.n100.p25")
#' g <- rCausalMGM::mgm(data.n100.p25)
mgm <- function(df, lambda = as.numeric( c(0.2)), maxDiscrete = 5L, verbose = as.logical( c(FALSE))) {
...
pcStable <- function(df, maxDiscrete = 5L, initialGraph = NULL, alpha = 0.05, threads = -1L, censoredCauses = as.logical( c(FALSE)), verbose = as.logical( c(FALSE))) {
    .Call(`_rCausalMGM_pcStable`, df, maxDiscrete, initialGraph, alpha, threads, censoredCauses, verbose)
}
...
cpcStable <- function(df, maxDiscrete = 5L, initialGraph = NULL, alpha = 0.05, threads = -1L, censoredCauses = as.logical( c(FALSE)), verbose = as.logical( c(FALSE))) {
    .Call(`_rCausalMGM_cpcStable`, df, maxDiscrete, initialGraph, alpha, threads, censoredCauses, verbose)
}
...
pcMax <- function(df, maxDiscrete = 5L, initialGraph = NULL, alpha = 0.05, threads = -1L, censoredCauses = as.logical( c(FALSE)), verbose = as.logical( c(FALSE))) {
    .Call(`_rCausalMGM_pcMax`, df, maxDiscrete, initialGraph, alpha, threads, censoredCauses, verbose)
}
...
pc50 <- function(df, maxDiscrete = 5L, initialGraph = NULL, alpha = 0.05, threads = -1L, censoredCauses = as.logical( c(FALSE)), verbose = as.logical( c(FALSE))) {
    .Call(`_rCausalMGM_pc50`, df, maxDiscrete, initialGraph, alpha, threads, censoredCauses, verbose)
}
...
fciStable <- function(df, maxDiscrete = 5L, initialGraph = NULL, alpha = 0.05, threads = -1L, censoredCauses = as.logical( c(FALSE)), verbose = as.logical( c(FALSE))) {
    .Call(`_rCausalMGM_fciStable`, df, maxDiscrete, initialGraph, alpha, threads, censoredCauses, verbose)
}
...
cfci <- function(df, maxDiscrete = 5L, initialGraph = NULL, alpha = 0.05, threads = -1L, censoredCauses = as.logical( c(FALSE)), verbose = as.logical( c(FALSE))) {
    .Call(`_rCausalMGM_cfci`, df, maxDiscrete, initialGraph, alpha, threads, censoredCauses, verbose)
}
...
fciMax <- function(df, maxDiscrete = 5L, initialGraph = NULL, alpha = 0.05, threads = -1L, censoredCauses = as.logical( c(FALSE)), verbose = as.logical( c(FALSE))) {
    .Call(`_rCausalMGM_fciMax`, df, maxDiscrete, initialGraph, alpha, threads, censoredCauses, verbose)
}

stars <- function(df, method, params = NULL, initialGraph = NULL, maxDiscrete = 5L, g = 0.05, numSub = 20L, leaveOneOut = as.logical( c(FALSE)), threads = -1L, verbose = as.logical( c(FALSE))) {
    .Call(`_rCausalMGM_stars`, df, method, params, initialGraph, maxDiscrete, g, numSub, leaveOneOut, threads, verbose)
}
