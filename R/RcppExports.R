...
CoxIRLSRegressionTest <- function(df, targetName, regressorNames, repetitions) {
    invisible(.Call(`_rCausalMGM_CoxIRLSRegressionTest`, df, targetName, regressorNames, repetitions))
}

CoxRegressionTest <- function(df, targetName, regressorNames, repetitions) {
    invisible(.Call(`_rCausalMGM_CoxRegressionTest`, df, targetName, regressorNames, repetitions))
}
...
causalMGMRandCvTest <- function(data, alg, lambdas, alphas, nfolds, fdr) {
    .Call(`_rCausalMGM_causalMGMRandCvTest`, data, alg, lambdas, alphas, nfolds, fdr)
}
