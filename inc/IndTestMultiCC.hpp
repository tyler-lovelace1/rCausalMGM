...
class IndTestMultiCC : public IndependenceTest {
private:
    int timesCalled;
...
public:
    ...
    IndTestMultiCC(DataSet& data, double alpha);

    IndTestMultiCC(DataSet& data, double alpha, bool preferLinear);
    ...
    bool isIndependentCoxRegression(Variable* x, Variable* y, std::vector<Variable*>& z, double* pReturn = NULL);
