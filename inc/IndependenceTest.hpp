...
class IndependenceTest
{
    public:
           ...
           */
          virtual IndependenceTest indTestSubset(std::list<Variable*>& vars) = 0;
           ...
           * getVariableNames().
           */
          virtual boolean isIndependent(Variable* x, Variable* y, std::list<Variable*>& z) = 0;
           ...
           * getVariableNames().
           */
          virtual boolean isDependent(Variable* x, Variable* y, std::list<Variable*>& z) = 0;
           ...
           * relations.
           */
          virtual std::list<Variable*>& getVariables() = 0;
           ...
           */
          virtual std::list<std::string*>& getVariableNames() = 0;

          /**
           * @return true if y is determined the variable in z.
           */
          virtual boolean determines(std::list<Variable*>& z, Node y) = 0;
          ...
          virtual std::list<DataSet*>& get getDataSets() = 0;
